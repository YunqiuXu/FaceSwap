...
CROP_SIZE = 64  # scale_size = CROP_SIZE
ngf = 64
ndf = 64
...
def process_image(x):
    ...
    # Tensor('batch:1', shape=(1, 64, 64, 3), dtype=float32) -> 1 batch size
...
if __name__ == '__main__':
    ...
    x = tf.placeholder(tf.uint8, shape=(64, 128, 3), name='image_tensor')  # input tensor
    y = generate_output(x)
