# Pix2pix GAN, modified by Yunqiu Xu
...
# Yunqiu Xu: remove 2 layers, the start size is 64*64*3
def create_generator(generator_inputs, generator_outputs_channels):
    ...
    layer_specs = [
        ...
        a.ngf * 8 # encoder_6: [batch, 2, 2, ngf * 8] => [batch, 1, 1, ngf * 8]
    ]
    ...
    layer_specs = [
        (a.ngf * 8, 0.5),   # decoder_6: [batch, 1, 1, ngf * 8 * 2] => [batch, 2, 2, ngf * 8 * 2]
        (a.ngf * 8, 0.0),   # decoder_5: [batch, 2, 2, ngf * 8 * 2] => [batch, 4, 4, ngf * 8 * 2]
        (a.ngf * 4, 0.0),   # decoder_4: [batch, 4, 4, ngf * 8 * 2] => [batch, 8, 8, ngf * 4 * 2]
        (a.ngf * 2, 0.0),   # decoder_3: [batch, 8, 8, ngf * 4 * 2] => [batch, 16, 16, ngf * 2 * 2]
        (a.ngf, 0.0),       # decoder_2: [batch, 16, 16, ngf * 2 * 2] => [batch, 32, 32, ngf * 2]
    ]
    ...
    # decoder_1: [batch, 32, 32, ngf * 2] => [batch, 64, 64, generator_outputs_channels]
